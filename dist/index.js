...
__export(src_exports, {
  ...
  FACTORY_ADDRESS_ETH: () => FACTORY_ADDRESS_ETH,
  FACTORY_ADDRESS_MAP: () => FACTORY_ADDRESS_MAP,
  FACTORY_ADDRESS_SHIB: () => FACTORY_ADDRESS_SHIB,
  FIVE: () => FIVE,
  Fraction: () => Fraction,
  ...
  INIT_CODE_HASH_ETH: () => INIT_CODE_HASH_ETH,
  INIT_CODE_HASH_MAP: () => INIT_CODE_HASH_MAP,
  INIT_CODE_HASH_SHIB: () => INIT_CODE_HASH_SHIB,
...
var ChainId = /* @__PURE__ */ ((ChainId2) => {
  ...
  ChainId2[ChainId2["BSC_TESTNET"] = 157] = "BSC_TESTNET";
...
var FACTORY_ADDRESS_BSC = "0xc7c86B4f940Ff1C13c736b697e3FbA5a6Bc979F9";
var FACTORY_ADDRESS_BSC_TESTNET = "0xEDedDbde5ffA62545eDF97054edC11013ED72125";
var FACTORY_ADDRESS_SHIB = "0xEDedDbde5ffA62545eDF97054edC11013ED72125";
var FACTORY_ADDRESS_DC = "0x7C10a3b7EcD42dd7D79C0b9d58dDB812f92B574A";
var FACTORY_ADDRESS_ETH = "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f";
var FACTORY_ADDRESS_MAP = {
  [56 /* BSC */]: FACTORY_ADDRESS_BSC,
  [157 /* BSC_TESTNET */]: FACTORY_ADDRESS_BSC_TESTNET,
  [109 /* SHIBARIUM */]: FACTORY_ADDRESS_SHIB,
  [2e3 /* DOGECHAIN */]: FACTORY_ADDRESS_DC,
  [1 /* ETH */]: FACTORY_ADDRESS_ETH
};
var INIT_CODE_HASH_BSC = "0x908a679b76436e6d853df6556fbcb55cbfe69fb45a6ac9fe0c1e0f2a53f7baf4";
var INIT_CODE_HASH_BSC_TESTNET = "0x4455b31327401d7d38602d2b84b8e6a3843289a04fa0ff3ef5195bb4a43f0688";
var INIT_CODE_HASH_SHIB = "0xa2ef75f706f4aa0c026dd9371dab1bac975a91bc8f0852a86e6f330eedd30848";
var INIT_CODE_HASH_DC = "0xb336a8b47fdc2600ed0b1be659f72b59cb3096a8dd3814eda610401c00f5fd49";
...
var INIT_CODE_HASH_MAP = {
  ...
  [157 /* BSC_TESTNET */]: INIT_CODE_HASH_BSC_TESTNET,
  [109 /* SHIBARIUM */]: INIT_CODE_HASH_SHIB,
  [2e3 /* DOGECHAIN */]: INIT_CODE_HASH_DC,
  [1 /* ETH */]: INIT_CODE_HASH_ETH
};
...
var WNATIVE = {
  [56 /* BSC */]: WBNB[56 /* BSC */],
  [157 /* BSC_TESTNET */]: WBNB[157 /* BSC_TESTNET */],
...
var Pair = class {
  ...
  getOutputAmount(inputAmount) {
    ...
    const outputAmount = CurrencyAmount2.fromRawAmount(
  ...
  getInputAmount(outputAmount) {
    ...
    const inputAmount = CurrencyAmount2.fromRawAmount(
  ...
  getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
    ...
    if (import_jsbi7.default.equal(totalSupply.quotient, ZERO)) {
      liquidity = import_jsbi7.default.subtract(
        sqrt(import_jsbi7.default.multiply(tokenAmounts[0].quotient, tokenAmounts[1].quotient)),
        MINIMUM_LIQUIDITY
      );
    } else {
  ...
  getLiquidityValue(token, totalSupply, liquidity, feeOn = false, kLast) {
    ...
    return CurrencyAmount2.fromRawAmount(
      token,
      import_jsbi7.default.divide(import_jsbi7.default.multiply(liquidity.quotient, this.reserveOf(token).quotient), totalSupplyAdjusted.quotient)
    );
  }
};
...
var Trade = class {
  ...
  constructor(route, amount, tradeType) {
    ...
    this.executionPrice = new Price2(
